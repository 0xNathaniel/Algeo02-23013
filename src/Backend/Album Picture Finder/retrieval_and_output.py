...
from pca import perform_pca, project_images
...
n_images = 100  # Number of top similar images to return
...
def main():
    ...
    principal_components, _, _ = perform_pca(standardized_images, n_components)
