...
export default function Home() {
  return (
    <div className='bg-[#F5F5F5]'>
      <div  className="w-full flex flex-col text-center py-[120px] text-[#1E2567]">
      ...
      <div className="flex flex-col space-y-5 py-10 px-[50px] sm:px-[80px] md:px-[100px] lg:px-[100px] items-center">
        <div className="flex flex-col space-y p-[80px] bg-white rounded-3xl lg:w-[1000px] shadow-lg">
